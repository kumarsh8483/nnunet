...
inputs_root = "/inputs" #change directory
outputs_root = "/Users/DSKumar-mda/nnunet/outputs" #change directory
task_name_cfg = "Task005_Prostate" #default_plans_identifier

print(os.listdir("/var/azureml-app/"))

def make_prediction(input_folder, output_folder):
    task_name = task_name_cfg
    network_dir = "nnunet_outputs/nnUNet" #change directory
...
def init():
    global model
    # print("/ : ", os.listdir("/"))
    # print("/ : ", os.listdir("/var/")) # chadirectory
